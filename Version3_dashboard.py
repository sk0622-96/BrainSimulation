...
Version 3 Dashboard
====================
Reads results from version3_history.json.
"""
...
def main():
    ...
    fig.suptitle('Version 3 Dashboard — Food Visibility + Run Tracking',
    ...
    # --- Chart 2: avg steps per generation ---
    gen_avg_steps = []
    ...
    # --- Chart 3: avg energy remaining per generation ---
    gen_avg_energy = []
    for g in range(1, max_gen + 1):
    ...
    out = '/Users/tommysupey/Desktop/Brain Simulation/version3_dashboard.png'
